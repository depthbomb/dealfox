...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			freedelivery.Table:     freedelivery.ValidColumn,
			freemonitor.Table:      freemonitor.ValidColumn,
			freeoffer.Table:        freeoffer.ValidColumn,
			freesubscription.Table: freesubscription.ValidColumn,
