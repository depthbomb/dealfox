...
func (_q *RuleQuery) QueryTarget() *TargetQuery {
...
func (_q *RuleQuery) QueryEvents() *EventQuery {
...
func (_q *RuleQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *RuleQuery) FirstIDX(ctx context.Context) string {
...
func (_q *RuleQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *RuleQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *RuleQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *RuleQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *RuleQuery) WithTarget(opts ...func(*TargetQuery)) *RuleQuery {
	query := (&TargetClient{config: _q.config}).Query()
...
func (_q *RuleQuery) WithEvents(opts ...func(*EventQuery)) *RuleQuery {
	query := (&EventClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RuleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Rule, error) {
	...
	if query := _q.withEvents; query != nil {
		if err := _q.loadEvents(ctx, query, nodes,
			func(n *Rule) { n.Edges.Events = []*Event{} },
			func(n *Rule, e *Event) { n.Edges.Events = append(n.Edges.Events, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *RuleQuery) loadTarget(ctx context.Context, query *TargetQuery, nodes []*Rule, init func(*Rule), assign func(*Rule, *Target)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Rule)
	for i := range nodes {
		fk := nodes[i].TargetID
...
func (_q *RuleQuery) loadEvents(ctx context.Context, query *EventQuery, nodes []*Rule, init func(*Rule), assign func(*Rule, *Event)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(event.FieldRuleID)
	}
	query.Where(predicate.Event(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(rule.EventsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *RuleQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(rule.Table, rule.Columns, sqlgraph.NewFieldSpec(rule.FieldID, field.TypeString))
	_spec.From = _q.sql
...
func (_q *RuleQuery) ForUpdate(opts ...sql.LockOption) *RuleQuery {
...
func (_q *RuleQuery) ForShare(opts ...sql.LockOption) *RuleQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
