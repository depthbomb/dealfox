...
type EventQuery struct {
	...
	withRule        *RuleQuery
	withObservation *ObservationQuery
...
func (_q *EventQuery) QueryRule() *RuleQuery {
...
func (_q *EventQuery) QueryObservation() *ObservationQuery {
...
func (_q *EventQuery) QueryDeliveries() *DeliveryQuery {
...
func (_q *EventQuery) WithRule(opts ...func(*RuleQuery)) *EventQuery {
	query := (&RuleClient{config: _q.config}).Query()
...
func (_q *EventQuery) WithObservation(opts ...func(*ObservationQuery)) *EventQuery {
	query := (&ObservationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *EventQuery) WithDeliveries(opts ...func(*DeliveryQuery)) *EventQuery {
	query := (&DeliveryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *EventQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Event, error) {
	...
	if query := _q.withRule; query != nil {
		if err := _q.loadRule(ctx, query, nodes, nil,
			func(n *Event, e *Rule) { n.Edges.Rule = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withObservation; query != nil {
		if err := _q.loadObservation(ctx, query, nodes, nil,
			func(n *Event, e *Observation) { n.Edges.Observation = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withDeliveries; query != nil {
		if err := _q.loadDeliveries(ctx, query, nodes,
			func(n *Event) { n.Edges.Deliveries = []*Delivery{} },
			func(n *Event, e *Delivery) { n.Edges.Deliveries = append(n.Edges.Deliveries, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *EventQuery) loadRule(ctx context.Context, query *RuleQuery, nodes []*Event, init func(*Event), assign func(*Event, *Rule)) error {
...
func (_q *EventQuery) loadObservation(ctx context.Context, query *ObservationQuery, nodes []*Event, init func(*Event), assign func(*Event, *Observation)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Event)
	for i := range nodes {
		fk := nodes[i].ObservationID
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
	...
	query.Where(observation.IDIn(ids...))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	}
...
func (_q *EventQuery) loadDeliveries(ctx context.Context, query *DeliveryQuery, nodes []*Event, init func(*Event), assign func(*Event, *Delivery)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(delivery.FieldEventID)
	}
	query.Where(predicate.Delivery(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(event.DeliveriesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *EventQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withRule != nil {
			_spec.Node.AddColumnOnce(event.FieldRuleID)
		}
		if _q.withObservation != nil {
			_spec.Node.AddColumnOnce(event.FieldObservationID)
		}
	}
