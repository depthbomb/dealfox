...
func (_q *DeliveryQuery) QueryEvent() *EventQuery {
...
func (_q *DeliveryQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *DeliveryQuery) FirstIDX(ctx context.Context) string {
...
func (_q *DeliveryQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *DeliveryQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *DeliveryQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *DeliveryQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *DeliveryQuery) WithEvent(opts ...func(*EventQuery)) *DeliveryQuery {
	query := (&EventClient{config: _q.config}).Query()
...
func (_q *DeliveryQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Delivery, error) {
	...
	if query := _q.withEvent; query != nil {
		if err := _q.loadEvent(ctx, query, nodes, nil,
			func(n *Delivery, e *Event) { n.Edges.Event = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DeliveryQuery) loadEvent(ctx context.Context, query *EventQuery, nodes []*Delivery, init func(*Delivery), assign func(*Delivery, *Event)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Delivery)
	for i := range nodes {
		fk := nodes[i].EventID
...
func (_q *DeliveryQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(delivery.Table, delivery.Columns, sqlgraph.NewFieldSpec(delivery.FieldID, field.TypeString))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withEvent != nil {
			_spec.Node.AddColumnOnce(delivery.FieldEventID)
		}
	}
