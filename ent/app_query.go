...
func (_q *AppQuery) QueryTargets() *TargetQuery {
...
func (_q *AppQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *AppQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *AppQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *AppQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *AppQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *AppQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AppQuery) WithTargets(opts ...func(*TargetQuery)) *AppQuery {
	query := (&TargetClient{config: _q.config}).Query()
...
func (_q *AppQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*App, error) {
	...
	if query := _q.withTargets; query != nil {
		if err := _q.loadTargets(ctx, query, nodes,
			func(n *App) { n.Edges.Targets = []*Target{} },
			func(n *App, e *Target) { n.Edges.Targets = append(n.Edges.Targets, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AppQuery) loadTargets(ctx context.Context, query *TargetQuery, nodes []*App, init func(*App), assign func(*App, *Target)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(target.FieldAppID)
	}
	query.Where(predicate.Target(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(app.TargetsColumn), fks...))
	}))
