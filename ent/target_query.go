...
func (_q *TargetQuery) QueryApp() *AppQuery {
...
func (_q *TargetQuery) QueryRules() *RuleQuery {
...
func (_q *TargetQuery) QueryObservations() *ObservationQuery {
...
func (_q *TargetQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *TargetQuery) FirstIDX(ctx context.Context) string {
...
func (_q *TargetQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *TargetQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *TargetQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *TargetQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *TargetQuery) WithApp(opts ...func(*AppQuery)) *TargetQuery {
	query := (&AppClient{config: _q.config}).Query()
...
func (_q *TargetQuery) WithRules(opts ...func(*RuleQuery)) *TargetQuery {
	query := (&RuleClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TargetQuery) WithObservations(opts ...func(*ObservationQuery)) *TargetQuery {
	query := (&ObservationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TargetQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Target, error) {
	...
	if query := _q.withApp; query != nil {
		if err := _q.loadApp(ctx, query, nodes, nil,
			func(n *Target, e *App) { n.Edges.App = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withObservations; query != nil {
		if err := _q.loadObservations(ctx, query, nodes,
			func(n *Target) { n.Edges.Observations = []*Observation{} },
			func(n *Target, e *Observation) { n.Edges.Observations = append(n.Edges.Observations, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TargetQuery) loadApp(ctx context.Context, query *AppQuery, nodes []*Target, init func(*Target), assign func(*Target, *App)) error {
...
func (_q *TargetQuery) loadRules(ctx context.Context, query *RuleQuery, nodes []*Target, init func(*Target), assign func(*Target, *Rule)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Target)
	for i := range nodes {
...
func (_q *TargetQuery) loadObservations(ctx context.Context, query *ObservationQuery, nodes []*Target, init func(*Target), assign func(*Target, *Observation)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Target)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(observation.FieldTargetID)
	}
	query.Where(predicate.Observation(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(target.ObservationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *TargetQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(target.Table, target.Columns, sqlgraph.NewFieldSpec(target.FieldID, field.TypeString))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withApp != nil {
			_spec.Node.AddColumnOnce(target.FieldAppID)
		}
	}
...
func (_q *TargetQuery) ForUpdate(opts ...sql.LockOption) *TargetQuery {
...
func (_q *TargetQuery) ForShare(opts ...sql.LockOption) *TargetQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
